...
print('Opening Anonymizer application setup')
...
if os.path.exists("C:/Users/Remote/anonymizer/"):
    ...
    run_anon = subprocess.Popen('C:/Users/Remote/Desktop/setup/setup.sh', shell=True, stdin=git_bash.stdout)
    run_anon.wait()
